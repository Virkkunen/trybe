...
DROP database IF EXISTS `northwind_test` ;
CREATE database IF NOT EXISTS `northwind_test` DEFAULT CHARACTER SET latin1 ;
USE `northwind_test` ;

-- -----------------------------------------------------
-- Table `northwind_test`.`customers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`customers` (
...
-- -----------------------------------------------------
-- Table `northwind_test`.`employees`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`employees` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `northwind_test`.`privileges`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`privileges` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `northwind_test`.`employee_privileges`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`employee_privileges` (
  ...
  CONSTRAINT `fk_employee_privileges_employees1`
    ...
    REFERENCES `northwind_test`.`employees` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_employee_privileges_privileges1`
    FOREIGN KEY (`privilege_id`)
    REFERENCES `northwind_test`.`privileges` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `northwind_test`.`inventory_transaction_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`inventory_transaction_types` (
...
-- -----------------------------------------------------
-- Table `northwind_test`.`shippers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`shippers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `northwind_test`.`orders_tax_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`orders_tax_status` (
  `id` TINYINT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `northwind_test`.`orders_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`orders_status` (
  `id` TINYINT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `northwind_test`.`orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`orders` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_orders_customers`
    ...
    REFERENCES `northwind_test`.`customers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_orders_shippers1`
    ...
    REFERENCES `northwind_test`.`shippers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_orders_tax_status1`
    FOREIGN KEY (`tax_status_id`)
    REFERENCES `northwind_test`.`orders_tax_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_orders_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `northwind_test`.`orders_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `northwind_test`.`products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`products` (
...
-- -----------------------------------------------------
-- Table `northwind_test`.`purchase_order_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`purchase_order_status` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `northwind_test`.`suppliers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`suppliers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `northwind_test`.`purchase_orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`purchase_orders` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_purchase_orders_purchase_order_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `northwind_test`.`purchase_order_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_purchase_orders_suppliers1`
    FOREIGN KEY (`supplier_id`)
    REFERENCES `northwind_test`.`suppliers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `northwind_test`.`inventory_transactions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`inventory_transactions` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `northwind_test`.`invoices`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`invoices` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `northwind_test`.`order_details_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`order_details_status` (
  `id` INT(11) NOT NULL,
  `status_name` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `northwind_test`.`order_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`order_details` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_order_details_order_details_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `northwind_test`.`order_details_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `northwind_test`.`purchase_order_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`purchase_order_details` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_purchase_order_details_inventory_transactions1`
    ...
    REFERENCES `northwind_test`.`inventory_transactions` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `northwind_test`.`sales_reports`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`sales_reports` (
...
-- -----------------------------------------------------
-- Table `northwind_test`.`strings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `northwind_test`.`strings` (
...
-- -------------------------------------------------
#
# Converted from MS Access 2010 Northwind database (accdb) using
