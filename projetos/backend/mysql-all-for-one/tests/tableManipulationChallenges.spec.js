...
describe('Desafios de manipulação de tabelas', () => {
  ...
  describe('Queries de inserção', () => {
    ...
    describe("Req20 - Adicione à tabela 'order_details' um registro com 'order_id': 69, 'product_id': 80, 'quantity': 15.0000, 'unit_price': 15.0000, 'discount': 0, 'status_id': 2, 'date_allocated': NULL, 'purchase_order_id': NULL e 'inventory_id': 129", () => {
    ...
    describe("Req21 - Adicione com um único 'INSERT', duas linhas à tabela 'order_details' com os mesmos dados do requisito 20", () => {
  ...
  describe('Queries de atualização', () => {
    ...
    describe("Req22 - Atualize todos os dados da coluna 'discount', na tabela 'order_details', para 15.", () => {
    ...
    describe("Req23 - Atualize os dados da coluna 'discount' da tabela 'order_details' para 30, onde o valor na coluna 'unit_price' seja menor que 10.0000", () => {
    ...
    describe("Req24 - Atualize os dados da coluna 'discount' da tabela 'order_details' para 45, onde o valor na coluna 'unit_price' seja maior que 10.0000 e o id seja um número entre 30 e 40", () => {
  ...
  describe('Queries de deleção', () => {
    ...
    describe("Req25 - Delete todos os dados na coluna 'unit_price' da tabela 'order_details' em que o valor seja menor que 10.0000", () => {
    ...
    describe("Req26 - Delete todos os dados na coluna 'unit_price' da tabela 'order_details' em que o valor seja maior que 10.0000", () => {
    ...
    describe("Req27 - Delete todos os dados da tabela 'order_details'", () => {
