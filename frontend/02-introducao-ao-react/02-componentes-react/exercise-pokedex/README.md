...
- Use o comando: `git clone git@github.com:tryber/sd-026-b-exercise-pokedex`.
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-026-b-exercise-pokedex`
...
- Agora crie uma branch à qual você vai submeter os `commits` do seu exercício
  ...
  - Exemplo: `git checkout -b joaozinho-sd-026-b-exercise-pokedex`
...
- Usando o exemplo anterior: `git push -u origin joaozinho-sd-026-b-exercise-pokedex`

6. Crie um novo `Pull Request` _(PR)_

- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-026-b-exercise-pokedex/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-026-b-exercise-pokedex/pulls) e confira que o seu _Pull Request_ está criado
